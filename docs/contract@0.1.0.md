...
These are externally observable guarantees.

---

## 3. Server truth (integration / boundary tests)
...
Any implementation that passes these tests is correct.

---

## 4. Client truth (runtime executables)
...
## 5. Ownership and file contracts
